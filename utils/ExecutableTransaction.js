...
ExecutableTransaction.prototype = {
  get: async function() {
    ...
    let messageToBeSigned = await oThis.web3.utils.soliditySha3(
    ...
    let signature = await oThis.web3.eth.sign(messageToBeSigned, oThis.signer);
    signature = signature.slice(2);
    let r = '0x' + signature.slice(0, 64),
      s = '0x' + signature.slice(64, 128),
      v = oThis.web3.utils.toDecimal('0x' + signature.slice(128, 130));
