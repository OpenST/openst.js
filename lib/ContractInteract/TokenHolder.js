...
const { EIP20CoGateway } = require('@openst/mosaic-contracts');
...
class TokenHolder {
  ...
  constructor(auxiliaryWeb3, address) {
    ...
    this.abiBinProvider.addABI('EIP20CoGateway', EIP20CoGateway.abi);
  ...
  getCoGatewayRedeemExecutableData(amount, beneficiary, gasPrice, gasLimit, nonce, hashLock) {
    const coGateway = new this.auxiliaryWeb3.eth.Contract(this.abiBinProvider.getABI('EIP20CoGateway'));
