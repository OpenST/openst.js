...
class User {
  ...
  getDelayedRecoveryModuleCreationData(delayedRecoveryModuleMasterCopyAddress, delayedRecoverySetupData) {
    const oThis = this;
  ...
  getCreateAndAddModulesData(proxyFactoryAddress, modulesCreationData) {
    const oThis = this;
  ...
  getGnosisSafeData(
    ...
    const createAndAddModulesData = oThis.getCreateAndAddModulesData(proxyFactoryAddress, [
  ...
  _createUserWalletRawTx(
    ...
    const contract = new oThis.auxiliaryWeb3.eth.Contract(jsonInterface, oThis.userWalletFactoryAddress);
