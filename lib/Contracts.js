...
class OpenSTContracts extends Contracts {
  ...
  TokenRules(contractAddress, txOptions) {
    ...
    const contractInstance = new this.auxiliaryWeb3.eth.Contract(jsonInterface, contractAddress, txOptions);
  ...
  GnosisSafe(contractAddress, txOptions) {
    ...
    let contractInstance = new this.auxiliaryWeb3.eth.Contract(jsonInterface, contractAddress, txOptions);
    return contractInstance;
  }
